 ...
 * microservice transport the gateway talks to. The @MessagePattern(ADMIN_PATTERNS.*) handlers
 * live in AdminController; admin-service fans out to the owning services (no DB of its own).
 */
